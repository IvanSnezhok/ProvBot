...
admin_keyboard.add(
    InlineKeyboardButton(
        text="Відправити повідомлення", callback_data="panel_send_message"
    ),
...
admin_account_menu.add(
    ...
    InlineKeyboardButton(
        text="Тимчасовий платіж", callback_data="admin_temporary_payment"
    ),
...
search_choice.add(
    InlineKeyboardButton(text="Номер договору", callback_data="search_contract"),
...
redact_alarm.add(
    ...
    InlineKeyboardButton(
        text="Змінити повідомлення", callback_data="change_message_alarm"
    ),
)
...
broadcast_confirm.add(
    InlineKeyboardButton(text="Відправити всім", callback_data="broadcast_send"),
    InlineKeyboardButton(text="Скасувати", callback_data="broadcast_cancel"),
)

broadcast_stop = InlineKeyboardMarkup()
broadcast_stop.add(
    InlineKeyboardButton(text="Зупинити розсилку", callback_data="broadcast_stop")
)
